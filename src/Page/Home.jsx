  ...
  useEffect(() => {
    const fetchNearbyHotels = async () => {
      if (latitude && longitude) {
        try {
          const response = await fetch(`http://localhost:1042/top-nearby?latitude=${latitude}&longitude=${longitude}`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        try {
          const response = await fetch(`http://localhost:1042/top-nearby?latitude=${23.816156}&longitude=${86.441976}`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
            },
